package com.bridzelabz.employeeWageDay9;
...
public class EmployeeWage {
			...
			public void wagesTillaCondition() {
				...
				public  void computeEmpWage(String company,int empRatePerHour,
			...
			public static void main(String[] args) {
		        ...
		        emp.computeEmpWage("reliance",25,4,40);
				emp.computeEmpWage("bajaj",20,4,30);
